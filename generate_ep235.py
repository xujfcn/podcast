...
ep = 235
title = 'EP235: AI API Gateway Configuration Drift - Detect When Regions and Workers Disagree'
description = 'A practical guide to configuration drift in AI API gateways: compare desired, published, active, and observed state while protecting policy, residency, capability, credentials, quotas, pricing, and tenant boundaries.'
pub_date = 'Fri, 28 Aug 2026 14:45:00 +0000'
