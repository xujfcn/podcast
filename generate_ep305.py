...
ep = 305
title = 'EP305: AI API Gateway Route Warmup - Make New Capacity Ready Before Traffic Arrives'
description = 'Prepare AI API gateway routes before production traffic with safe, idempotent warmup for workers, adapters, connections, credentials, caches, capabilities, rollout gates, and autoscaling.'
pub_date = 'Sun, 30 Aug 2026 13:45:00 +0000'
