...
ep = 308
title = 'EP308: AI API Gateway Routing Decision Caches - Speed Up Routing Without Serving Stale Policy'
description = 'Design AI API gateway routing decision caches with complete keys, dependency-aware freshness, safe invalidation, capacity checks, authorization boundaries, explainability, and race testing.'
pub_date = 'Sun, 30 Aug 2026 15:15:00 +0000'
