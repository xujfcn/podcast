...
ep = 522
title = 'EP522: Policy Remediation Follow-up - Close Exceptions and Review Residual Risk'
description = 'A practical guide to closing, renewing, and governing temporary AI gateway policy decisions with enforceable scope, current evidence, expiry, and residual-risk review.'
pub_date = 'Sun, 13 Sep 2026 18:50:00 +0000'
