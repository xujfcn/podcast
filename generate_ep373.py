...
ep = 373
title = 'EP373: AI API Gateway Policy Dependencies - Keep Every Decision Input Compatible and Fresh'
description = 'Govern the classifiers, identity attributes, provider facts, consent records, registries, schemas, and external lists that give policy rules their meaning.'
pub_date = 'Tue, 01 Sep 2026 07:15:00 +0000'
