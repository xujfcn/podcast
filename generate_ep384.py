...
ep = 384
title = 'EP384: AI API Gateway Policy Rollback Safety - Restore Rules Without Reopening Risk'
description = 'Roll back policy safely with immutable targets, semantic checks, dependency validation, in-flight request handling, staged activation, and decision reconciliation.'
pub_date = 'Tue, 01 Sep 2026 12:45:00 +0000'
