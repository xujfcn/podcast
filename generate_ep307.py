...
ep = 307
title = 'EP307: AI API Gateway Stream Recovery - Reconnect Without Duplicating Work'
description = 'Design AI API gateway streaming recovery with durable stream identities, ordered events, bounded replay, reconnect leases, cancellation races, tool-effect boundaries, truthful billing, and failover semantics.'
pub_date = 'Sun, 30 Aug 2026 14:45:00 +0000'
