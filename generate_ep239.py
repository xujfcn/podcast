...
ep = 239
title = 'EP239: AI API Gateway SLOs - Turn Reliability Targets Into Routing Decisions'
description = 'A practical guide to SLOs for AI API gateways: measure semantic correctness, policy, tools, latency, usage, billing, and uncertainty—and use those objectives to drive routing and recovery.'
pub_date = 'Fri, 28 Aug 2026 16:45:00 +0000'
