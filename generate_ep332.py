...
ep = 332
title = 'EP332: AI API Gateway Model Alias Governance - Resolve Friendly Names Without Losing Control'
description = 'Govern AI model aliases across version resolution, capabilities, rollout, routing, caching, billing, regional availability, fallback, rollback, and audit.'
pub_date = 'Mon, 31 Aug 2026 03:45:00 +0000'
