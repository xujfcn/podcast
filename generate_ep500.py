...
ep = 500
title = 'EP500: Policy Evidence Lifecycles - Explain, Correct, and Delete Without Rewriting History'
description = 'Govern policy evidence from creation through correction, restriction, retention, and deletion while preserving honest replay status and current authorization boundaries.'
pub_date = 'Thu, 10 Sep 2026 11:15:00 +0000'
