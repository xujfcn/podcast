...
ep = 396
title = 'EP396: AI API Gateway Policy Enforcement Ordering - Put Every Control Before the Risk'
description = 'Design and verify the order of authentication, classification, authorization, budgeting, routing, transformation, and side-effect controls.'
pub_date = 'Tue, 01 Sep 2026 18:45:00 +0000'
