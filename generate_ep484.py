...
ep = 484
title = 'EP484: Policy Exception Workflows - Temporary Authority Without Permanent Drift'
description = 'Design safe policy exception workflows for AI gateways: bounded policy deltas, independent approvals, compensating controls, automatic expiry, revocation, telemetry, and a path from emergency access back to ordinary policy.'
pub_date = 'Mon, 07 Sep 2026 21:15:00 +0000'
