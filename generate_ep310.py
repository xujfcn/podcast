...
ep = 310
title = 'EP310: AI API Gateway Token-Aware Load Balancing - Distribute Work, Not Request Counts'
description = 'Design token-aware AI API load balancing with bounded workload estimates, committed-work accounting, model-specific throughput, cache locality, stream tracking, fairness, failover, and billing reconciliation.'
pub_date = 'Sun, 30 Aug 2026 16:45:00 +0000'
