...
ep = 415
title = 'EP415: AI API Gateway Connection Draining - Finish Accepted Work Before Instances Leave'
description = 'Drain AI gateway instances safely across HTTP, streams, WebSockets, queues, agents, providers, tools, deployments, scale-in, and failover.'
pub_date = 'Wed, 02 Sep 2026 10:45:00 +0000'
