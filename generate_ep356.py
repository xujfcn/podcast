...
ep = 356
title = 'EP356: AI API Gateway Delegated Authority - Let Agents Act Without Letting Permissions Expand'
description = 'Govern delegated authority across users, agents, sub-agents, tools, budgets, approvals, asynchronous jobs, tenant boundaries, revocation, and external side effects.'
pub_date = 'Mon, 31 Aug 2026 16:45:00 +0000'
