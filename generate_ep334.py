...
ep = 334
title = 'EP334: AI API Gateway Capability Declarations - Route by What Providers Can Prove'
description = 'Make AI provider capabilities verifiable for routing with typed, versioned facts covering limits, feature combinations, regions, account scope, probes, snapshots, adapters, fallback, billing, and drift.'
pub_date = 'Mon, 31 Aug 2026 04:45:00 +0000'
