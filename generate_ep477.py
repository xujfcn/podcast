...
ep = 477
title = 'EP477: Deadline-Aware Admission Control - Keeping AI Gateways Reliable Under Load'
description = 'Design deadline-aware admission control for AI gateways: reserve multidimensional capacity, protect in-flight work, queue fairly, shed load early, preserve fallback headroom, and make every overload decision explainable.'
pub_date = 'Mon, 07 Sep 2026 00:15:00 +0000'
