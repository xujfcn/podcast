...
ep = 304
title = 'EP304: AI API Gateway Request Shape Governance - Budget Work Before It Enters the Queue'
description = 'Govern AI API request shape with multidimensional budgets for tokens, context, tools, media, time, and cost, using negotiation, transparent transformations, queue weighting, and provider-aware enforcement.'
pub_date = 'Sun, 30 Aug 2026 13:15:00 +0000'
