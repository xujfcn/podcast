...
ep = 378
title = 'EP378: AI API Gateway Policy Invariants - Make Safety Properties Survive Every Change'
description = 'Define and enforce policy properties that must survive edits, upgrades, retries, failover, exceptions, transformations, and degraded operation.'
pub_date = 'Tue, 01 Sep 2026 09:45:00 +0000'
