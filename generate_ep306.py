...
ep = 306
title = 'EP306: AI API Gateway Session Affinity - Keep Stateful Work on the Right Route'
description = 'Design AI API gateway session affinity with scoped keys, durable state, safe migration, fencing, expiration, failover fidelity, tenant isolation, tool ordering, and observable recovery.'
pub_date = 'Sun, 30 Aug 2026 14:15:00 +0000'
