...
ep = 315
title = 'EP315: AI API Gateway Time Semantics - Make Deadlines and Events Tell the Truth'
description = 'Design reliable AI API gateway time semantics with monotonic deadlines, event ordering, clock-skew bounds, late callbacks, expiration rules, cross-region leases, and delayed usage settlement.'
pub_date = 'Sun, 30 Aug 2026 19:15:00 +0000'
