...
ep = 512
title = 'EP512: Policy Evidence Access Anomaly Triage - Investigate Suspicious Reads Without Losing Control'
description = 'Investigate suspicious policy-evidence reads with purpose validation, effective-scope checks, delegation tracing, destination analysis, proportionate containment, honest uncertainty, and cross-layer reconciliation.'
pub_date = 'Fri, 11 Sep 2026 15:18:00 +0000'
