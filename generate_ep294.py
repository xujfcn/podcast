...
ep = 294
title = 'EP294: AI API Gateway Batch Scheduling - Improve Throughput Without Losing Guarantees'
description = 'Design AI API gateway batch scheduling with compatibility keys, bounded windows, cost-aware packing, fairness, cancellation, partial failure semantics, item-level retries, and per-item accounting.'
pub_date = 'Sun, 30 Aug 2026 07:15:00 +0000'
