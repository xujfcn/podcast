...
ep = 476
title = 'EP476: Provider Contracts and Capability Negotiation - Route by What Endpoints Can Actually Do'
description = 'Design machine-checkable provider contracts for AI gateways: version capabilities, calculate real request envelopes, negotiate tools and streaming, detect drift, prevent silent downgrades, and preserve evidence for every route decision.'
pub_date = 'Sun, 06 Sep 2026 21:15:00 +0000'
