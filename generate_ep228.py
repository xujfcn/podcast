...
ep = 228
title = 'EP228: AI API Gateway Request Lineage - Make Every Response Explainable'
description = 'A practical guide to request lineage for AI API gateways: connect identity, policy, routing, attempts, streams, tools, resources, usage, billing, and final outcomes into one explainable story.'
pub_date = 'Fri, 28 Aug 2026 11:15:00 +0000'
