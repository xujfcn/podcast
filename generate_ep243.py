...
ep = 243
title = 'EP243: AI API Gateway Model Deprecation - Retire Versions Without Breaking Clients'
description = 'A practical guide to retiring AI models safely: discover dependencies, evaluate replacements, migrate prompts and tools, canary traffic, preserve billing, and plan rollback through provider churn.'
pub_date = 'Fri, 28 Aug 2026 18:45:00 +0000'
