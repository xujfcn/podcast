...
ep = 266
title = 'EP266: AI API Gateway Provider Attestation - Prove Which Service Answered'
description = 'A practical guide to provider attestation in AI API gateways: distinguish requested and executed models, preserve evidence, bind retries to lineage, protect metadata, and represent uncertainty honestly.'
pub_date = 'Sat, 29 Aug 2026 09:15:00 +0000'
