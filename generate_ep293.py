...
ep = 293
title = 'EP293: AI API Gateway Multi-Region Failover - Preserve Semantics Across Locations'
description = 'Design multi-region AI API gateway failover that preserves data boundaries, request identity, configuration, deadlines, idempotency, provider provenance, and billing reconciliation.'
pub_date = 'Sun, 30 Aug 2026 06:45:00 +0000'
