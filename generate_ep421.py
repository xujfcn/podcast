...
ep = 421
title = 'EP421: AI API Gateway Tool Authorization Freshness - Recheck Permission Before Every Side Effect'
description = 'Recheck AI tool authorization, target identity, parameters, revocation state, and policy freshness before every meaningful external side effect.'
pub_date = 'Wed, 02 Sep 2026 18:45:00 +0000'
