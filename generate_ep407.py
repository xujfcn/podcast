...
ep = 407
title = 'EP407: AI API Gateway Policy Degradation - Preserve Safety When Evaluation Is Incomplete'
description = 'Define bounded policy degradation for evaluator failures, stale dependencies, control-plane outages, partial decisions, and recovery without expanding authority.'
pub_date = 'Wed, 02 Sep 2026 00:45:00 +0000'
