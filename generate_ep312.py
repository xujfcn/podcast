...
ep = 312
title = 'EP312: AI API Gateway Capability Negotiation - Route by What Models Can Actually Do'
description = 'Design model capability negotiation for AI API gateways with versioned declarations, safe probes, parameter-level validation, explicit degradation, tool and streaming contracts, policy boundaries, and evidence-driven routing.'
pub_date = 'Sun, 30 Aug 2026 17:45:00 +0000'
