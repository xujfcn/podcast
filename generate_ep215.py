...
ep = 215
title = 'EP215: AI API Gateway Usage Reconciliation - Make Every Charge Explainable'
description = 'A practical guide to usage reconciliation for AI API gateways: link logical operations to attempts, delayed usage, retries, fallbacks, streaming, tools, and versioned pricing.'
pub_date = 'Fri, 28 Aug 2026 07:45:00 +0000'
