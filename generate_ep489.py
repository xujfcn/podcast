...
ep = 489
title = 'EP489: Canonical Operation History - Correct the Facts Without Rewriting the Past'
description = 'Build a versioned canonical operation history for AI gateways: preserve observations, revise projections when provider, policy, billing, or deletion facts change, and keep past decisions explainable.'
pub_date = 'Fri, 11 Sep 2026 23:15:00 +0000'
