...
ep = 547
title = 'EP547: Remediation Assurance Exception Decision Records - Make Escalation Outcomes Durable'
description = 'How AI API gateway teams can turn an escalation outcome into a durable, enforceable, and reviewable control state.'
