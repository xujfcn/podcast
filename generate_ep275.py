...
ep = 275
title = 'EP275: AI API Gateway Health Probes - Test Readiness Before You Route Production Traffic'
description = 'A practical guide to AI gateway health probes: separate liveness from readiness, test real capabilities safely, bound probe cost, version evidence, detect semantic failures, and connect health to routing.'
pub_date = 'Sat, 29 Aug 2026 13:45:00 +0000'
