...
ep = 416
title = 'EP416: AI API Gateway Connection Admission - Reuse Transport Without Reusing Authority'
description = 'Govern connection authentication, multiplexing, reuse, pools, budgets, credential rotation, protocol limits, and request-level admission.'
pub_date = 'Wed, 02 Sep 2026 11:15:00 +0000'
