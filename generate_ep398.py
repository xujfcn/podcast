...
ep = 398
title = 'EP398: AI API Gateway Policy Artifact Supply Chains - Ship Trusted Rules From Source to Runtime'
description = 'Secure the policy path from source and dependencies through reproducible builds, signatures, registries, distribution, and runtime loading.'
pub_date = 'Tue, 01 Sep 2026 19:45:00 +0000'
