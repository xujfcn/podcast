...
ep = 428
title = 'EP428: AI API Gateway Tool Result Confidentiality - Keep Sensitive Outputs From Leaking Across Boundaries'
description = 'Protect AI tool results with provenance, purpose, sensitivity, field-level views, destination controls, retention, and tenant isolation.'
pub_date = 'Thu, 03 Sep 2026 09:45:00 +0000'
