...
ep = 405
title = 'EP405: AI API Gateway Decision Freshness Governance - Stop Stale Authorization From Surviving'
description = 'Govern decision freshness with risk-based validity, dependency ages, revocation epochs, queue and cache controls, and point-of-use reauthorization.'
pub_date = 'Tue, 01 Sep 2026 23:45:00 +0000'
