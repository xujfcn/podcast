...
ep = 496
title = 'EP496: Policy Decision Freshness Governance - Stop Stale Authorization From Surviving'
description = 'Govern authorization freshness with bounded leases, policy epochs, invalidation, and commit-time checks so stale decisions cannot survive into real effects.'
pub_date = 'Fri, 18 Sep 2026 23:15:00 +0000'
