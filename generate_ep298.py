...
ep = 298
title = 'EP298: AI API Gateway Expiration Semantics - Stop Stale Work From Surviving Its Deadline'
description = 'Design AI API gateway expiration semantics with separate clocks, monotonic state, deadline-aware retries, safe side-effect checks, bounded intermediate retention, durable cleanup, and late usage reconciliation.'
pub_date = 'Sun, 30 Aug 2026 10:15:00 +0000'
