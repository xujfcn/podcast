...
ep = 472
title = 'EP472: AI API Gateway Operation Lifecycles - From Intent to Reconciliation'
description = 'Design an end-to-end AI gateway operation ledger that preserves idempotency, reservations, routing decisions, provider attempts, streaming state, tool side effects, retries, usage, and reconciliation across partial failures.'
pub_date = 'Sun, 06 Sep 2026 09:15:00 +0000'
