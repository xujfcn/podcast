...
ep = 443
title = 'EP443: AI API Gateway Tool Result Contract Retirement Governance - Retire Old Guarantees Without Leaving Unsafe Paths'
description = 'Resolve conflicting tool evidence with explicit authority, identity, freshness, uncertainty, reconciliation, and safe downstream actions.'
pub_date = 'Thu, 03 Sep 2026 15:45:00 +0000'
