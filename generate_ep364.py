...
ep = 364
title = 'EP364: AI API Gateway Claim Verification - Make Evidence Support What Answers Say'
description = 'Verify AI answer claims against current authoritative evidence with citation checks, freshness, contradictions, deterministic validation, and risk-based delivery gates.'
pub_date = 'Tue, 01 Sep 2026 02:15:00 +0000'
