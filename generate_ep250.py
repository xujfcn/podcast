...
ep = 250
title = 'EP250: AI API Gateway Content Provenance - Know Where Every Answer Came From'
description = 'Episode 250 explains content provenance for AI gateways: trace models, prompts, sources, tools, fallbacks, caches, transformations, citations, and uncertainty without creating a new data leak.'
pub_date = 'Fri, 28 Aug 2026 22:45:00 +0000'
