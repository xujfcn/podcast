...
ep = 333
title = 'EP333: AI API Gateway Prompt Assembly - Preserve Source, Priority, and Boundaries'
description = 'Govern AI prompt assembly with typed fragments, explicit precedence, provenance, tenant scope, retrieval and tool boundaries, multimodal identity, protected constraints, deterministic rendering, truncation evidence, and provider adapter checks.'
pub_date = 'Mon, 31 Aug 2026 04:15:00 +0000'
