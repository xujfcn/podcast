...
ep = 330
title = 'EP330: AI API Gateway Request Canonicalization - Make Identity Stable Without Changing Meaning'
description = 'Canonicalize AI API gateway requests safely for signatures, idempotency, caching, routing, and audit while preserving message order, Unicode, defaults, tools, multimodal identity, policy context, and semantic differences.'
pub_date = 'Mon, 31 Aug 2026 02:45:00 +0000'
