...
ep = 286
title = 'EP286: AI API Gateway Cancellation Contracts - Stop Work When the User Leaves'
description = 'Design cancellation contracts for AI API gateways that propagate aborts, stop queued and streaming work, protect side effects, prevent retry amplification, and reconcile provider usage.'
pub_date = 'Sat, 29 Aug 2026 20:45:00 +0000'
