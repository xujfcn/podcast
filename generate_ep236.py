...
ep = 236
title = 'EP236: AI API Gateway Incident Command - Coordinate Decisions Under Pressure'
description = 'A practical guide to incident command for AI API gateways: establish roles, preserve evidence, choose scoped mitigations, coordinate teams, and verify recovery across the full request lifecycle.'
pub_date = 'Fri, 28 Aug 2026 15:15:00 +0000'
