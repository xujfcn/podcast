...
ep = 227
title = 'EP227: AI API Gateway Rollback Design - Restore Safe Behavior Without Losing State'
description = 'A practical guide to rollback design for AI API gateways: restore routes safely while preserving in-flight state, streaming outcomes, tool effects, policy, capacity, usage, billing, and evidence.'
pub_date = 'Fri, 28 Aug 2026 10:45:00 +0000'
