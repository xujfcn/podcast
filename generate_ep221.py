...
ep = 221
title = 'EP221: AI API Gateway Failure Capsules - Make Intermittent Bugs Reproducible'
description = 'A practical guide to failure capsules for AI API gateways: preserve privacy-aware evidence across state, timing, routes, streams, retries, tools, usage, and cleanup so rare bugs become replayable.'
pub_date = 'Fri, 28 Aug 2026 09:15:00 +0000'
