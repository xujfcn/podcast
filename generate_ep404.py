...
ep = 404
title = 'EP404: AI API Gateway Policy Decision Binding - Keep Authority Attached to Context'
description = 'Bind policy decisions to the exact subject, tenant, purpose, resource, route, tool, audience, time, and obligations so valid decisions cannot be misused elsewhere.'
pub_date = 'Tue, 01 Sep 2026 23:15:00 +0000'
