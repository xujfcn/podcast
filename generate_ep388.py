...
ep = 388
title = 'EP388: AI API Gateway Authorization Decision Caches - Reuse Permission Without Reusing Risk'
description = 'Govern authorization decision caches with complete context keys, risk-based freshness, precise invalidation, tenant isolation, obligation binding, and safe revalidation.'
pub_date = 'Tue, 01 Sep 2026 14:45:00 +0000'
