...
ep = 432
title = 'EP432: AI API Gateway Tool Result Claim Binding - Keep Answers Attached to Evidence'
description = 'Keep every important tool-derived claim attached to immutable evidence, scope, time, transformations, verification level, and delivery policy.'
pub_date = 'Thu, 03 Sep 2026 14:15:00 +0000'
