...
ep = 348
title = 'EP348: AI API Gateway Purpose Limitation - Use Data Only for the Reason It Was Approved'
description = 'Govern AI API data use across inference, caching, observability, evaluation, debugging, human review, training, derived artifacts, retention, consent, and deletion.'
pub_date = 'Mon, 31 Aug 2026 12:45:00 +0000'
