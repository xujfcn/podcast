...
ep = 316
title = 'EP316: AI API Gateway Execution Leases - Recover Work Without Creating Two Owners'
description = 'Design AI API gateway execution ownership with leases, fencing generations, atomic takeover, single-writer streams, idempotent tool effects, provider reconciliation, cross-region safety, and generation-aware billing.'
pub_date = 'Sun, 30 Aug 2026 19:45:00 +0000'
