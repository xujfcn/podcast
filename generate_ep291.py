...
ep = 291
title = 'EP291: AI API Gateway Provider Attestation - Prove Which Service Answered'
description = 'Build provider attestation for AI API gateways with attempt identities, evidence boundaries, signatures, safe metadata, billing links, unknown handling, and verification tests.'
pub_date = 'Sun, 30 Aug 2026 05:45:00 +0000'
