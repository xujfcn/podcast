...
ep = 538
title = 'EP538: Remediation Evidence Lifecycle - Prove That the Fix Survives Real Operation'
description = 'How AI API gateway teams can keep remediation evidence meaningful from collection through retention, reuse, review, and retirement, with practical controls for provenance, scope, integrity, and assurance decisions.'
pub_date = 'Mon, 14 Sep 2026 03:20:00 +0000'
