...
ep = 218
title = 'EP218: AI API Gateway Load Shedding - Preserve the Core User Journey'
description = 'A practical guide to load shedding for AI API gateways: define essential work, detect pressure, protect critical traffic, bound queues and fan-out, shed safely, and recover gradually.'
