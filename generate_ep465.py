...
ep = 465
title = 'EP465: AI API Gateway Multi-Provider Failover and Graceful Degradation - Recover Without Breaking Semantics'
description = 'Design safe multi-provider failover with idempotency, operation state, streaming recovery, side-effect reconciliation, explicit degradation tiers, and honest client-visible status.'
pub_date = 'Sat, 05 Sep 2026 15:15:00 +0000'
