...
ep = 325
title = 'EP325: AI API Gateway Tool Execution Boundaries - Control External Side Effects'
description = 'Separate AI model reasoning from effectful tools with durable execution identities, approval and commit phases, provider-aware idempotency, unknown-outcome handling, least privilege, compensation, reconciliation, and audit evidence.'
pub_date = 'Mon, 31 Aug 2026 00:15:00 +0000'
