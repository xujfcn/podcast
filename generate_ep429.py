...
ep = 429
title = 'EP429: AI API Gateway Tool Result Retention - Keep Sensitive Outputs Only As Long As Needed'
description = 'Retain AI tool results only as long as needed while preserving purpose, provenance, deletion, data minimization, and audit evidence.'
pub_date = 'Thu, 03 Sep 2026 10:45:00 +0000'
