...
ep = 229
title = 'EP229: AI API Gateway Cancellation Contracts - Stop Work When the User Leaves'
description = 'A practical guide to cancellation contracts for AI API gateways: propagate user intent through queues, providers, streams, retries, tools, and billing while preserving unknown outcomes.'
pub_date = 'Fri, 28 Aug 2026 11:45:00 +0000'
