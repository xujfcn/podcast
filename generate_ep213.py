...
ep = 213
title = 'EP213: AI API Gateway State Machines - Make Request Lifecycles Explicit'
description = 'A practical guide to state machines for AI API gateways: model logical operations and provider attempts, guard deadlines and cancellation, commit streaming outcomes, preserve evidence, and test races.'
pub_date = 'Fri, 28 Aug 2026 05:15:00 +0000'
