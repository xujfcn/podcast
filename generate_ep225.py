...
ep = 225
title = 'EP225: AI API Gateway Change Failure Analysis - Find Why Safe-Looking Changes Break Production'
description = 'A practical guide to change failure analysis for AI API gateways: reconstruct timelines, expose hidden coupling and contract drift, analyze blast radius, and turn incidents into guardrails.'
pub_date = 'Fri, 28 Aug 2026 09:45:00 +0000'
