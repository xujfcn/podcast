...
ep = 546
title = 'EP546: Remediation Assurance Exception Escalation - Route Unresolved Risk to the Right Authority'
description = 'How AI API gateway teams can route unresolved proof gaps to the right decision-maker without losing scope, evidence, or operational control.'
pub_date = 'Tue, 15 Sep 2026 00:30:00 +0000'
...
for i, part in enumerate(parts, 1):
    ...
    cmd = ['edge-tts', '--voice', 'en-US-GuyNeural', '--text', part, '--write-media', str(out)]
