...
ep = 383
title = 'EP383: AI API Gateway Policy Continuity - Enforce Safe Rules When the Control Plane Is Down'
description = 'Preserve bounded, verified policy enforcement through control-plane, evaluator, fact-service, and regional failures without extending stale authority forever.'
pub_date = 'Tue, 01 Sep 2026 12:15:00 +0000'
