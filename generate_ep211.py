...
ep = 211
title = 'EP211: AI API Gateway Cancellation Contracts - Stop Work When the User Leaves'
description = 'A practical guide to cancellation contracts for AI API gateways: propagate deadlines and stop signals, release capacity, handle partial streams and tool side effects, reconcile billing, and test cancellation races.'
pub_date = 'Fri, 28 Aug 2026 03:45:00 +0000'
