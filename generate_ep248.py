...
ep = 248
title = 'EP248: AI API Gateway Secret Management - Keep Credentials Out of Prompts, Logs, and Tools'
description = 'A practical guide to secret management in AI gateways: isolate credentials, authorize access by tenant and purpose, rotate safely, constrain tools, sanitize telemetry, and verify revocation.'
pub_date = 'Fri, 28 Aug 2026 21:45:00 +0000'
