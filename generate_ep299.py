...
ep = 299
title = 'EP299: AI API Gateway Model Availability - Know When a Route Is Really Ready'
description = 'Define reliable AI API gateway model availability states from listed and enabled to healthy, ready, degraded, and retired, with safe probes, scoped policy, freshness, and recovery evidence.'
pub_date = 'Sun, 30 Aug 2026 10:45:00 +0000'
