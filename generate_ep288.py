...
ep = 288
title = 'EP288: AI API Gateway Response Acceptance - Do Not Confuse HTTP 200 with Success'
description = 'A practical response-acceptance contract for AI API gateways covering layered validation, semantic invariants, safe repair, fallbacks, tool calls, streaming, provider differences, and adversarial tests.'
pub_date = 'Sun, 30 Aug 2026 04:15:00 +0000'
