...
ep = 533
title = 'EP533: Remediation Persistence Testing - Prove Corrective Actions Survive Normal Change'
description = 'How AI API gateway teams test remediation assumptions across ordinary releases, provider changes, policy updates, mixed versions, runtime paths, and evidence systems.'
pub_date = 'Mon, 14 Sep 2026 00:50:00 +0000'
