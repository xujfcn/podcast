...
ep = 328
title = 'EP328: AI API Gateway Credential Leases - Authorize Each Request for Exactly as Long as Needed'
description = 'Bind short-lived AI API gateway provider authorization to requests, tenants, regions, policies, streams, retries, tools, and workers with scoped expiry, revocation, rotation, fencing, reconciliation, and audit evidence.'
pub_date = 'Mon, 31 Aug 2026 01:45:00 +0000'
