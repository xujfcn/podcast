...
ep = 352
title = 'EP352: AI API Gateway Sensitive Data Tokenization - Reveal Values Only Where They Are Needed'
description = 'Govern sensitive-data tokenization across detection, scoped mappings, prompts, streams, structured output, tools, restoration authorization, caches, retries, and deletion.'
pub_date = 'Mon, 31 Aug 2026 14:45:00 +0000'
