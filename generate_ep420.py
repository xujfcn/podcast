...
ep = 420
title = 'EP420: AI API Gateway Tool Result Integrity - Verify What Tools Really Returned'
description = 'Verify AI tool result provenance, completeness, freshness, schema, tenant scope, authorization, and external side-effect status.'
pub_date = 'Wed, 02 Sep 2026 14:15:00 +0000'
