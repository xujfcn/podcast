...
ep = 287
title = 'EP287: AI API Gateway Request Priority - Allocate Scarce Capacity by Need'
description = 'Design request priority at the AI API gateway with explicit classes, authorization, cost-aware scheduling, deadlines, tenant fairness, safe preemption, and measurable outcomes.'
pub_date = 'Sun, 30 Aug 2026 02:15:00 +0000'
