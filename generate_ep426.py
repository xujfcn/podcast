...
ep = 426
title = 'EP426: AI API Gateway Tool Scope Governance - Keep One Permission From Becoming Many Actions'
description = 'Govern precise AI tool scopes so permissions remain bounded across targets, data flow, fan-out, retries, delegation, and provider execution.'
pub_date = 'Thu, 03 Sep 2026 06:45:00 +0000'
