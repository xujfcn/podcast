...
ep = 246
title = 'EP246: AI API Gateway Prompt Injection Defense - Keep Untrusted Instructions Out of Control Paths'
description = 'A practical guide to prompt injection defense in AI API gateways: separate data from authority, constrain tools and egress, protect control planes, preserve provenance, and test end-to-end.'
pub_date = 'Fri, 28 Aug 2026 20:15:00 +0000'
