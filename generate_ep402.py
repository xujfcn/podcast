...
ep = 402
title = 'EP402: AI API Gateway Policy Decision Determinism - Reproduce the Same Safe Result'
description = 'Make policy decisions reproducible across retries, evaluators, regions, and time by freezing inputs, facts, clocks, semantics, and uncertainty.'
pub_date = 'Tue, 01 Sep 2026 22:15:00 +0000'
