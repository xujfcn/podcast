...
ep = 482
title = 'EP482: Delegated Agent Identity - Pass Narrow Authority Without Impersonation'
description = 'Design verifiable delegated identity and authorization chains for AI gateways: separate identity from permission, attenuate scopes, bind credentials to audiences, protect approvals, constrain sub-agents, renew authority at side-effect boundaries, and test revocation, replay, and confused-deputy failures.'
pub_date = 'Mon, 07 Sep 2026 15:15:00 +0000'
