...
ep = 346
title = 'EP346: AI API Gateway Policy Exceptions - Govern Temporary Bypasses Without Losing Control'
description = 'Govern AI gateway policy exceptions across scope, approval, expiry, emergency access, compensating controls, propagation, revocation, auditing, and retirement.'
pub_date = 'Mon, 31 Aug 2026 11:45:00 +0000'
