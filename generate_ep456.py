...
ep = 456
title = 'EP456: AI API Gateway Tool Result Contract Evidence Admissibility - Decide Which Proof May Enter the Decision'
description = 'Decide whether tool result evidence may enter a decision based on source, collection, identity, policy, contract, and purpose.'
pub_date = 'Fri, 04 Sep 2026 00:45:00 +0000'
