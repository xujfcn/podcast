...
ep = 511
title = 'EP511: Policy Evidence Access Accounting - Prove Every Read Had a Purpose'
description = 'Account for every policy evidence use with principal and purpose binding, effective-scope measurement, destination tracking, tamper-evident receipts, and cross-layer reconciliation.'
pub_date = 'Fri, 11 Sep 2026 08:15:00 +0000'
